...
public class GenerateTripGraph {
...
//    public GenerateTripGraph(HashMap<String, HashMap> tripHashMap, HashMap<String, HashMap> passengerTripHashMap) {
...
//    }
    ...
    public GenerateTripGraph(HashMap<String, HashMap> tripHashMap, HashMap<String, Passenger> passengerList) {
        this.nodeArrayList = new ArrayList<>();
        this.tripHashMap = tripHashMap; //<Day, <RouteID, <CardID, ArrayList<Trip>>>>
    ...
    private void createNode() {
        System.out.println("1. Generate Nodes");
        Node node;
        for (Passenger passenger : passengerList.values()) {
                    ...
                    for (int j = i + 1; j < cardIDList.length; j++) {
                        ...
                        for (Trip trip1 : tripList1) {
                            ...
                            for (Trip trip2 : tripList2) {
                                ...
                                infRatio = tripCalculation.getInfRatio(trip1, trip2);
